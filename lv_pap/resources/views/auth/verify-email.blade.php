<x-guest-layout>
    <x-authentication-card>
        ...
        <div class="mb-4 text-sm text-gray-600">
            {{ __('Antes de continuar, poderia verificar o seu endereço de email clicando no link que acabamos de enviar? Se não recebeu nada, teremos todo o gosto em enviar outro.') }}
        </div>
